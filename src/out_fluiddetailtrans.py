...
def fluiddetaltrans_loop_calc(diag_mx, diag_my, it, iss, phi_ed, Al_ed, mom_ed, flag, outdir, tt):
    ...
    for py in range(max(-global_ny-my, -global_ny), min(global_ny, global_ny-my)+1):
        ...
        for px in range(max(-nx-mx, -nx), min(nx, nx-mx)+1):
            qx = -px-mx
            jkpq_es[:,:,py,px] = - ceff[:,:] * (-kx_ed[px]*ky_ed[qy]+ky_ed[py]*kx_ed[qx])                                    * np.real((phi_ed[:,:,py,px]*mom_ed[:,:,qy,qx]                                              -phi_ed[:,:,qy,qx]*mom_ed[:,:,py,px])*mom_ed[:,:,my,mx])
            jpqk_es[:,:,py,px] = - ceff[:,:] * (-kx_ed[qx]*ky_ed[my]+ky_ed[qy]*kx_ed[mx])                                    * np.real((phi_ed[:,:,qy,qx]*mom_ed[:,:,my,mx]                                              -phi_ed[:,:,my,mx]*mom_ed[:,:,qy,qx])*mom_ed[:,:,py,px])
            jqkp_es[:,:,py,px] = - ceff[:] * (-kx_ed[mx]*ky_ed[py]+ky_ed[my]*kx_ed[px])                                    * np.real((phi_ed[:,:,my,mx]*mom_ed[:,:,py,px]                                              -phi_ed[:,:,py,px]*mom_ed[:,:,my,mx])*mom_ed[:,:,qy,qx])
    ...
    for py in range(max(-global_ny-my, -global_ny), min(global_ny, global_ny-my)+1):
        ...
        for px in range(max(-nx-mx, -nx), min(nx, nx-mx)+1):
            qx = -px-mx
            jkpq_em[0,:,py,px] =                 (-ceff*(-kx_ed[px]*ky_ed[qy]+ky_ed[py]*kx_ed[qx])*                 np.real(Al_ed[:,py,px]*mom_ed[0,:,qy,qx]*mom_ed[1,:,my,mx]                        -Al_ed[:,qy,qx]*mom_ed[0,:,py,px]*mom_ed[1,:,my,mx]                        +Al_ed[:,py,px]*mom_ed[1,:,qy,qx]*mom_ed[0,:,my,mx]                        -Al_ed[:,qy,qx]*mom_ed[1,:,py,px]*mom_ed[0,:,my,mx]) )   
            jpqk_em[0,:,py,px] =                 (-ceff*(-kx_ed[px]*ky_ed[qy]+ky_ed[py]*kx_ed[qx])*                 np.real(Al_ed[:,qy,qx]*mom_ed[0,:,my,mx]*mom_ed[1,:,py,px]                        -Al_ed[:,my,mx]*mom_ed[0,:,qy,qx]*mom_ed[1,:,py,px]                        +Al_ed[:,qy,qx]*mom_ed[1,:,my,mx]*mom_ed[0,:,py,px]                        -Al_ed[:,my,mx]*mom_ed[1,:,qy,qx]*mom_ed[0,:,py,px]) )  
            jqkp_em[0,:,py,px] =                 (-ceff*(-kx_ed[px]*ky_ed[qy]+ky_ed[py]*kx_ed[qx])*                 np.real(Al_ed[:,my,mx]*mom_ed[0,:,py,px]*mom_ed[1,:,qy,qx]                        -Al_ed[:,py,px]*mom_ed[0,:,my,mx]*mom_ed[1,:,qy,qx]                        +Al_ed[:,my,mx]*mom_ed[1,:,py,px]*mom_ed[0,:,qy,qx]                        -Al_ed[:,py,px]*mom_ed[1,:,my,mx]*mom_ed[0,:,qy,qx]) )
    imom = 1
    ceff = 0.5*fcs[iss]*tau[iss]*Znum[iss] * (- np.sqrt(tau[iss]/Anum[iss]))             
    for py in range(max(-global_ny-my, -global_ny), min(global_ny, global_ny-my)+1):
        qy = -py-my
        for px in range(max(-nx-mx, -nx), min(nx, nx-mx)+1):
            qx = -px-mx
            jkpq_em[1,:,py,px] =                 (-ceff*(-kx_ed[px]*ky_ed[qy]+ky_ed[py]*kx_ed[qx])*                 np.real(Al_ed[:,py,px]*mom_ed[1,:,qy,qx]*mom_ed[2,:,my,mx]                        -Al_ed[:,qy,qx]*mom_ed[1,:,py,px]*mom_ed[2,:,my,mx]                        +Al_ed[:,py,px]*mom_ed[2,:,qy,qx]*mom_ed[1,:,my,mx]                        -Al_ed[:,qy,qx]*mom_ed[2,:,py,px]*mom_ed[1,:,my,mx]) )   
            jpqk_em[1,:,py,px] =                 (-ceff*(-kx_ed[px]*ky_ed[qy]+ky_ed[py]*kx_ed[qx])*                 np.real(Al_ed[:,qy,qx]*mom_ed[1,:,my,mx]*mom_ed[2,:,py,px]                        -Al_ed[:,my,mx]*mom_ed[1,:,qy,qx]*mom_ed[2,:,py,px]                        +Al_ed[:,qy,qx]*mom_ed[2,:,my,mx]*mom_ed[1,:,py,px]                        -Al_ed[:,my,mx]*mom_ed[2,:,qy,qx]*mom_ed[1,:,py,px]) )  
            jqkp_em[1,:,py,px] =                 (-ceff*(-kx_ed[px]*ky_ed[qy]+ky_ed[py]*kx_ed[qx])*                 np.real(Al_ed[:,my,mx]*mom_ed[1,:,py,px]*mom_ed[2,:,qy,qx]                        -Al_ed[:,py,px]*mom_ed[1,:,my,mx]*mom_ed[2,:,qy,qx]                        +Al_ed[:,my,mx]*mom_ed[2,:,py,px]*mom_ed[1,:,qy,qx]                        -Al_ed[:,py,px]*mom_ed[2,:,my,mx]*mom_ed[1,:,qy,qx]) ) 
    imom = 2
    ...
    for py in range(max(-global_ny-my, -global_ny), min(global_ny, global_ny-my)+1):
        ...
        for px in range(max(-nx-mx, -nx), min(nx, nx-mx)+1):
            qx = -px-mx
            jkpq_em[2,:,py,px] =                 (-ceff*(-kx_ed[px]*ky_ed[qy]+ky_ed[py]*kx_ed[qx])*                 np.real(Al_ed[:,py,px]*mom_ed[2,:,qy,qx]*mom_ed[4,:,my,mx]                        -Al_ed[:,qy,qx]*mom_ed[2,:,py,px]*mom_ed[4,:,my,mx]                        +Al_ed[:,py,px]*mom_ed[4,:,qy,qx]*mom_ed[2,:,my,mx]                        -Al_ed[:,qy,qx]*mom_ed[4,:,py,px]*mom_ed[2,:,my,mx]) )   
            jpqk_em[2,:,py,px] =                 (-ceff*(-kx_ed[px]*ky_ed[qy]+ky_ed[py]*kx_ed[qx])*                 np.real(Al_ed[:,qy,qx]*mom_ed[2,:,my,mx]*mom_ed[4,:,py,px]                        -Al_ed[:,my,mx]*mom_ed[2,:,qy,qx]*mom_ed[4,:,py,px]                        +Al_ed[:,qy,qx]*mom_ed[4,:,my,mx]*mom_ed[2,:,py,px]                        -Al_ed[:,my,mx]*mom_ed[4,:,qy,qx]*mom_ed[2,:,py,px]) )  
            jqkp_em[2,:,py,px] =                 (-ceff*(-kx_ed[px]*ky_ed[qy]+ky_ed[py]*kx_ed[qx])*                 np.real(Al_ed[:,my,mx]*mom_ed[2,:,py,px]*mom_ed[4,:,qy,qx]                        -Al_ed[:,py,px]*mom_ed[2,:,my,mx]*mom_ed[4,:,qy,qx]                        +Al_ed[:,my,mx]*mom_ed[4,:,py,px]*mom_ed[2,:,qy,qx]                        -Al_ed[:,py,px]*mom_ed[4,:,my,mx]*mom_ed[2,:,qy,qx]) ) 
    imom = 3
    ceff = 0.5*fcs[iss]*tau[iss]*Znum[iss] * (- np.sqrt(tau[iss]/Anum[iss]))             
    for py in range(max(-global_ny-my, -global_ny), min(global_ny, global_ny-my)+1):
        qy = -py-my
        for px in range(max(-nx-mx, -nx), min(nx, nx-mx)+1):
            qx = -px-mx
            jkpq_em[3,:,py,px] =                 (-ceff*(-kx_ed[px]*ky_ed[qy]+ky_ed[py]*kx_ed[qx])*                 np.real(Al_ed[:,py,px]*mom_ed[3,:,qy,qx]*mom_ed[5,:,my,mx]                        -Al_ed[:,qy,qx]*mom_ed[3,:,py,px]*mom_ed[5,:,my,mx]                        +Al_ed[:,py,px]*mom_ed[5,:,qy,qx]*mom_ed[3,:,my,mx]                        -Al_ed[:,qy,qx]*mom_ed[5,:,py,px]*mom_ed[3,:,my,mx]) )   
            jpqk_em[3,:,py,px] =                 (-ceff*(-kx_ed[px]*ky_ed[qy]+ky_ed[py]*kx_ed[qx])*                 np.real(Al_ed[:,qy,qx]*mom_ed[3,:,my,mx]*mom_ed[5,:,py,px]                        -Al_ed[:,my,mx]*mom_ed[3,:,qy,qx]*mom_ed[5,:,py,px]                        +Al_ed[:,qy,qx]*mom_ed[5,:,my,mx]*mom_ed[3,:,py,px]                        -Al_ed[:,my,mx]*mom_ed[5,:,qy,qx]*mom_ed[3,:,py,px]) )  
            jqkp_em[3,:,py,px] =                 (-ceff*(-kx_ed[px]*ky_ed[qy]+ky_ed[py]*kx_ed[qx])*                 np.real(Al_ed[:,my,mx]*mom_ed[3,:,py,px]*mom_ed[5,:,qy,qx]                        -Al_ed[:,py,px]*mom_ed[3,:,my,mx]*mom_ed[5,:,qy,qx]                        +Al_ed[:,my,mx]*mom_ed[5,:,py,px]*mom_ed[3,:,qy,qx]                        -Al_ed[:,py,px]*mom_ed[5,:,my,mx]*mom_ed[3,:,qy,qx]) ) 
    # Flux surface average and summation over imom
    cfsrf = np.sum(rootg[:])
    wfct = (rootg[:] / cfsrf).reshape(1,len(rootg), 1, 1)
...
if (__name__ == '__main__'):
    ...
    fluiddetailtrans_loop(diag_mx, diag_my, it, iss, xr_phi, xr_Al, xr_mom, flag="display", outdir="../data/")
